...
export function TestTemplate(): h.JSX.Element {
    return (
        ...
        <div className="sys" style="width: 25em; margin: 0 auto">
            <h1>Top-level header</h1>
            <h2>Hello world</h2>

            <p>
                Lorem ipsum dolor sit amet, <a href="#important">consectetur</a> adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate
                velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt
                in culpa qui officia deserunt mollit anim id est laborum. H<sub>2</sub>O
            </p>
            ...
            <p>
                ...
                . Ut enim ad<sup>[5]</sup> minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
